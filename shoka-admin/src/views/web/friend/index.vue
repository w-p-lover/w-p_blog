    ...
    <el-table border :data="friendList" @selection-change="handleSelectionChange" v-loading="loading">
      ...
      <el-table-column prop="avatar" label="友链头像" align="center" width="100">
        <template #default="scope">
          <img :src="scope.row.avatar" width="40" height="40" alt="" class="friend-avatar" />
        </template>
      </el-table-column>
      ...
      <el-table-column
          ...
          width="180"
      />
      <el-table-column prop="url" label="友链地址" align="center" width="220" />
      <el-table-column
          prop="introduction"
          label="友链介绍"
          align="center"
    ...
    <el-dialog :title="title" v-model="addOrUpdate" width="450px" append-to-body>
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button @click="addOrUpdate = false">取消</el-button>
        </div>
      </template>
    </el-dialog>
  </div>
