(() => {
    ...
    var t, e, a = {
        783: (t, e, a) => {
            var i = a(618), r = Object.create(null), n = "undefined" == typeof document, c = Array.prototype.forEach;
            ...
            function d(t) {
                if (!t) return !1;
                var e = document.querySelectorAll("link"), a = !1;
            ...
            t.exports = function (t, e) {
                if (n) return s;
                var a, c, o, l = function (t) {
                    var e = r[t];
                    if (!e) {
                        if (document.currentScript) e = document.currentScript.src; else {
                            var a = document.getElementsByTagName("script"), n = a[a.length - 1];
                            n && (e = n.src)
                        }
                        r[t] = e
                    }
            ...
            t.exports = function (t) {
                ...
                var e = -1 !== t.indexOf("//") ? t.split("//")[0] + "//" : "",
                    a = t.replace(new RegExp(e, "i"), "").split("/"), i = a[0].toLowerCase().replace(/\.$/, "");
            ...
            function c(t) {
                ...
                const r = currentCaptcha.currentCaptchaData.startX, c = currentCaptcha.currentCaptchaData.startY,
                ...
                }), window.addEventListener("mousemove", s), window.addEventListener("mouseup", d), window.addEventListener("touchmove", s, !1), window.addEventListener("touchend", d, !1), window.currentCaptcha.doDown && window.currentCaptcha.doDown(t, window.currentCaptcha)
            }
            ...
            function s(t) {
                ...
                h.push(u), l < 0 ? l = 0 : l > o && (l = o), window.currentCaptcha.currentCaptchaData.moveX = l, window.currentCaptcha.currentCaptchaData.movePercent = l / d, window.currentCaptcha.currentCaptchaData.moveY = p, window.currentCaptcha.doMove && window.currentCaptcha.doMove(t, currentCaptcha)
            }

            function o() {
                window.removeEventListener("mousemove", s), window.removeEventListener("mouseup", d), window.removeEventListener("touchmove", s), window.removeEventListener("touchend", d)
            }
            ...
            function d(t) {
                ...
                let a = e.x, i = e.y;
                const r = currentCaptcha.currentCaptchaData.startX, c = currentCaptcha.currentCaptchaData.startY,
                    s = currentCaptcha.currentCaptchaData.startTime, d = currentCaptcha.currentCaptchaData.trackArr,
                    h = {x: a - r, y: i - c, type: "up", t: (new Date).getTime() - s.getTime()};
                d.push(h), window.currentCaptcha.doUp && window.currentCaptcha.doUp(t, window.currentCaptcha), window.currentCaptcha.endCallback(currentCaptcha.currentCaptchaData, currentCaptcha)
            }
            ...
            function l(t, e) {
                A(t).find("#tianai-captcha-tips").removeClass("tianai-captcha-tips-on"), e && setTimeout(e, .35)
            }

            function p(t, e, a, i) {
                const r = A(t).find("#tianai-captcha-tips");
                r.text(e), 1 === a ? (r.removeClass("tianai-captcha-tips-error"), r.addClass("tianai-captcha-tips-success")) : (r.removeClass("tianai-captcha-tips-success"), r.addClass("tianai-captcha-tips-error")), r.addClass("tianai-captcha-tips-on"), setTimeout(i, 1e3)
            }
            ...
            class g {
                constructor(t, e) {
                    ...
                    if (t instanceof g) this.dom = t.dom, this.domStr = t.domStr; else if ("string" == typeof t) this.dom = document.querySelector(t), this.domStr = t; else {
                ...
                removeClass(t) {
                    ...
                    if (e.classList) e.classList.remove(t); else {
                        const a = e.className, i = new RegExp("(?:^|\\s)" + t + "(?!\\S)", "g");
                ...
                css(t, e) {
                    if ("string" == typeof t && "string" == typeof e) this.getTarget().style[t] = e; else if ("object" == typeof t) for (var a in t) t.hasOwnProperty(a) && (this.getTarget().style[a] = t[a]); else if ("string" == typeof t && void 0 === e) return window.getComputedStyle(element)[t]
                }
                ...
                is(t) {
                    return t && "object" == typeof t && void 0 !== t.nodeType ? this.dom === t : t instanceof g ? this.dom === t.dom : void 0
                }

                append(t) {
                    if ("string" == typeof t) this.getTarget().insertAdjacentHTML("beforeend", t); else {
            ...
            const f = class extends u {
                ...
                loadCaptchaForData(t, e) {
                    ...
                    a.attr("src", e.captcha.backgroundImage), i.attr("src", e.captcha.templateImage), a.on("load", (() => {
                        t.currentCaptchaData = h(a.width(), a.height(), i.width(), i.height(), 242), t.currentCaptchaData.currentCaptchaId = e.id
                    }))
                }
            };
            a(305);
            const m = class extends u {
                constructor(t, e) {
                    super(), this.boxEl = A(t), this.styleConfig = e, this.type = "ROTATE", this.currentCaptchaData = {}
                }
            ...
            const v = class extends u {
                constructor(t, e) {
                    super(), this.boxEl = A(t), this.styleConfig = e, this.type = "CONCAT", this.currentCaptchaData = {}
                }

                init(t, e, a) {
                    return this.destroy(), this.boxEl.append((this.styleConfig, '\n    <div id="tianai-captcha" class="tianai-captcha-slider tianai-captcha-concat">\n    <div class="slider-tip">\n        <span id="tianai-captcha-slider-move-track-font" >拖动滑块完成拼图</span>\n    </div>\n    <div class="content">\n        <div class="tianai-captcha-slider-concat-img-div" id="tianai-captcha-slider-concat-img-div">\n            <img id="tianai-captcha-slider-concat-slider-img" src="" alt/>\n        </div>\n        <div class="tianai-captcha-slider-concat-bg-img"></div>\n         <div class="tianai-captcha-tips" id="tianai-captcha-tips"></div>\n    </div>\n    <div class="slider-move">\n        <div class="slider-move-track">\n            <div id="tianai-captcha-slider-move-track-mask"></div>\n            <div class="slider-move-shadow"></div>\n        </div>\n        <div class="slider-move-btn" id="tianai-captcha-slider-move-btn">\n        </div>\n    </div>\n</div>\n    ')), this.el = this.boxEl.find("#tianai-captcha"), this.loadStyle(), this.el.find("#tianai-captcha-slider-move-btn").mousedown(c), this.el.find("#tianai-captcha-slider-move-btn").touchstart(c), r(this.el), window.currentCaptcha = this, this.loadCaptchaForData(this, t), this.endCallback = e, a && a(this), this
                }
                ...
                loadCaptchaForData(t, e) {
                    ...
                    a.css("background-image", "url(" + e.captcha.backgroundImage + ")"), i.css("background-image", "url(" + e.captcha.backgroundImage + ")"), i.css("background-position", "0px 0px");
                    var r = e.captcha.backgroundImageHeight, n = (r - e.captcha.data.randomY) / r * 180;
                    i.css("height", n + "px"), t.currentCaptchaData = h(a.width(), a.height(), i.width(), i.height(), 242), t.currentCaptchaData.currentCaptchaId = e.id
                }
            };
            a(492);
            const C = class extends u {
                constructor(t, e) {
                    super(), this.boxEl = A(t), this.styleConfig = e, this.type = "IMAGE_CLICK", this.currentCaptchaData = {}
                }

                init(t, e, a) {
                    return this.destroy(), this.boxEl.append((this.styleConfig, '\n<div id="tianai-captcha" class="tianai-captcha-slider tianai-captcha-word-click">\n    <div class="click-tip">\n        <span id="tianai-captcha-click-track-font" >请依次点击:</span>\n        <img src="" id="tianai-captcha-tip-img" class="tip-img">\n    </div>\n    <div class="content">\n        <div class="bg-img-div">\n            <img id="tianai-captcha-slider-bg-img" src="" alt/>\n            <canvas id="tianai-captcha-slider-bg-canvas"></canvas>\n            <div id="bg-img-click-mask"></div>\n        </div>\n         <div class="tianai-captcha-tips" id="tianai-captcha-tips"></div>\n    </div>\n</div>\n')), this.el = this.boxEl.find("#tianai-captcha"), window.currentCaptcha = this, this.loadCaptchaForData(this, t), this.endCallback = e, this.el.find("#bg-img-click-mask").click((t => {
                        this.currentCaptchaData.clickCount++;
                        const e = this.currentCaptchaData.trackArr, a = this.currentCaptchaData.startTime;
                        1 === this.currentCaptchaData.clickCount && (window.addEventListener("mousemove", s), this.currentCaptchaData.startX = t.offsetX, this.currentCaptchaData.startY = t.offsetY), e.push({
                            x: Math.round(t.offsetX),
                            y: Math.round(t.offsetY),
                            type: "click",
                            t: (new Date).getTime() - a.getTime()
                        });
                        const i = t.offsetX - 10, r = t.offsetY - 10;
                        this.el.find("#bg-img-click-mask").append("<span class='click-span' style='left:" + i + "px;top: " + r + "px'>" + this.currentCaptchaData.clickCount + "</span>"), 4 === this.currentCaptchaData.clickCount && (this.currentCaptchaData.stopTime = new Date, window.removeEventListener("mousemove", s), this.endCallback(this.currentCaptchaData, this))
                    })), a && a(this), this
                }
                ...
                loadCaptchaForData(t, e) {
                    const a = t.el.find("#tianai-captcha-slider-bg-img"), i = t.el.find("#tianai-captcha-tip-img");
                    a.on("load", (() => {
                        t.currentCaptchaData = h(a.width(), a.height(), i.width(), i.height()), t.currentCaptchaData.currentCaptchaId = e.id
                    })), a.attr("src", e.captcha.backgroundImage), i.attr("src", e.captcha.templateImage)
                }
            };
            ...
            class b {
                constructor(t) {
                    ...
                    this.bindEl = t.bindEl, this.domBindEl = A(t.bindEl), this.requestCaptchaDataUrl = t.requestCaptchaDataUrl, this.validCaptchaUrl = t.validCaptchaUrl, t.validSuccess && (this.validSuccess = t.validSuccess), t.validFail && (this.validFail = t.validFail), t.requestHeaders ? this.requestHeaders = t.requestHeaders : this.requestHeaders = {}, t.btnCloseFun && (this.btnCloseFun = t.btnCloseFun), t.btnRefreshFun && (this.btnRefreshFun = t.btnRefreshFun), this.requestChain = [], this.timeToTimestamp = t.timeToTimestamp, this.insertRequestChain(0, {
                        preRequest(t, e, a, i) {
                            if (this.timeToTimestamp && e.data) for (let t in e.data) e.data[t] instanceof Date && (e.data[t] = e.data[t].getTime());
                            return !0
                        }
                    })
                }
                ...
                doSendRequest(t) {
                    if (t.headers) for (const e in t.headers) if (t.headers[e].indexOf("application/json") > -1) {
                        "string" != typeof t.data && (t.data = JSON.stringify(t.data));
                        break
                    }
                    return (e = t, new Promise((function (t, a) {
                        var i = new XMLHttpRequest;
                        if (i.open(e.method || "GET", e.url), e.headers) for (const t in e.headers) e.headers.hasOwnProperty(t) && i.setRequestHeader(t, e.headers[t]);
                        i.onreadystatechange = function () {
                            if (i.readyState === XMLHttpRequest.DONE) if (i.status >= 200 && i.status <= 500) {
                ...
                validCaptcha(t, e, a, i) {
                    const r = {id: t, data: e};
                    let n = {};
                    n.headers = this.requestHeaders || {}, n.data = r, n.headers["Content-Type"] = "application/json;charset=UTF-8", n.method = "POST", n.url = this.validCaptchaUrl, this._preRequest("validCaptcha", n, a, i);
                    return this.doSendRequest(n).then((t => (this._postRequest("validCaptcha", n, t, a, i), t))).then((t => {
                        if (200 == t.code) {
            ...
            window.TAC = class {
                ...
                loadStyle() {
                    const t = this.style.bgUrl, e = this.style.logoUrl;
                ...
                createCaptcha() {
                    this.config.requestCaptchaData().then((t => {
                        ...
                        e.init(t, ((t, e) => {
                            const a = e.currentCaptchaData, i = {
                ...
                destroyCaptcha(t) {
                    window.currentCaptcha ? (window.currentCaptcha.el.css("transform", "translateX(300px)"), setTimeout((() => {
    ...
    function r(t) {
        ...
        try {
            ...
            r.i.forEach((function (t) {
                t(c)
            })), n = c.module, c.factory.call(n.exports, n, n.exports, c.require)
        } catch (t) {
            throw n.error = t, t
        }
        return n.exports
    ...
    r.m = a, r.c = i, r.i = [], r.hu = t => t + "." + r.h() + ".hot-update.js", r.miniCssF = t => {
    }, r.hmrF = () => "main." + r.h() + ".hot-update.json", r.h = () => "4017d115f7b426a57c5b", r.g = function () {
    ...
    }(), r.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), t = {}, e = "webpack-demo:", r.l = (a, i, n, c) => {
        if (t[a]) t[a].push(i); else {
            var s, o;
            if (void 0 !== n) for (var d = document.getElementsByTagName("script"), h = 0; h < d.length; h++) {
                var l = d[h];
            ...
            s || (o = !0, (s = document.createElement("script")).charset = "utf-8", s.timeout = 120, r.nc && s.setAttribute("nonce", r.nc), s.setAttribute("data-webpack", e + n), s.src = a), t[a] = [i];
            var p = (e, i) => {
        ...
        var t, e, a, i = {}, n = r.c, c = [], s = [], o = "idle", d = 0, h = [];
        ...
        function u(t) {
            ...
            return l("check").then(r.hmrM).then((function (a) {
                return a ? l("prepare").then((function () {
                    var i = [];
                    return e = [], Promise.all(Object.keys(r.hmrC).reduce((function (t, n) {
                        return r.hmrC[n](a.c, a.r, a.m, t, e, i), t
                    }), [])).then((function () {
                        return e = function () {
                            return t ? g(t) : l("ready").then((function () {
                                return i
                            }))
        ...
        function g(t) {
            ...
            if (r.length > 0) return l("abort").then((function () {
                throw r[0]
            }));
            var n = l("dispose");
        ...
        function f() {
            if (a) return e || (e = []), Object.keys(r.hmrI).forEach((function (t) {
        ...
        r.hmrD = i, r.i.push((function (h) {
            var g, f, m, v, C = h.module, w = function (e, a) {
                var i = n[a];
                if (!i) return e;
                var r = function (r) {
                    if (i.hot.active) {
                ...
                for (var h in e) Object.prototype.hasOwnProperty.call(e, h) && "e" !== h && Object.defineProperty(r, h, s(h));
            ...
            C.hot = (g = h.id, f = C, v = {
                ...
                accept: function (t, e, a) {
                    if (void 0 === t) v._selfAccepted = !0; else if ("function" == typeof t) v._selfAccepted = t; else if ("object" == typeof t && null !== t) for (var i = 0; i < t.length; i++) v._acceptedDependencies[t[i]] = e || function () {
                    }, v._acceptedErrorHandlers[t[i]] = a; else v._acceptedDependencies[t] = e || function () {
                ...
                invalidate: function () {
                    switch (this._selfInvalidated = !0, o) {
                        case"idle":
                            e = [], Object.keys(r.hmrI).forEach((function (t) {
                                r.hmrI[t](g, e)
                            })), l("ready");
                            break;
                        case"ready":
                ...
                data: i[g]
            }, t = void 0, v), C.parents = c, C.children = [], c = [], h.require = w
        })), r.hmrC = {}, r.hmrI = {}
    })(), (() => {
        var t;
        ...
        if ("undefined" != typeof document) {
            var t = (t, e, a, i, r) => {
                ...
                return n.onerror = n.onload = a => {
                    if (n.onerror = n.onload = null, "load" === a.type) i(); else {
                        var c = a && ("load" === a.type ? "missing" : a.type), s = a && a.target && a.target.href || e,
                            o = new Error("Loading CSS chunk " + t + " failed.\n(" + s + ")");
                        o.code = "CSS_CHUNK_LOAD_FAILED", o.type = c, o.request = s, n.parentNode && n.parentNode.removeChild(n), r(o)
                    }
                }, n.href = e, a ? a.parentNode.insertBefore(n, a.nextSibling) : document.head.appendChild(n), n
            }, e = (t, e) => {
            ...
            r.hmrC.miniCss = (c, s, o, d, h, l) => {
                h.push(n), c.forEach((n => {
                    var c = r.miniCssF(n), s = r.p + c, o = e(c, s);
                    o && d.push(new Promise(((e, r) => {
                        var c = t(n, s, o, (() => {
        ...
        function d(t) {
            function s(t) {
                for (var e = [t], a = {}, i = e.map((function (t) {
                    ...
                    var n = i.pop(), c = n.id, s = n.chain, d = r.c[c];
                    if (d && (!d.hot._selfAccepted || d.hot._selfInvalidated)) {
                        ...
                        for (var h = 0; h < d.parents.length; h++) {
                            ...
                            if (p) {
                                ...
                                -1 === e.indexOf(l) && (p.hot._acceptedDependencies[c] ? (a[l] || (a[l] = []), o(a[l], [c])) : (delete a[l], e.push(l), i.push({
                                    chain: s.concat([l]),
                                    id: l
                                })))
                            }
            ...
            var d = {}, h = [], l = {}, p = function (t) {
            };
            for (var u in a) if (r.o(a, u)) {
                var A, g = a[u], f = !1, m = !1, v = !1, C = "";
                switch ((A = g ? s(u) : {
                    type: "disposed",
                    moduleId: u
                }).chain && (C = "\nUpdate propagation: " + A.chain.join(" -> ")), A.type) {
                    case"self-declined":
                        t.onDeclined && t.onDeclined(A), t.ignoreDeclined || (f = new Error("Aborted because of self decline: " + A.moduleId + C));
                        break;
                    case"declined":
                        t.onDeclined && t.onDeclined(A), t.ignoreDeclined || (f = new Error("Aborted because of declined dependency: " + A.moduleId + " in " + A.parentId + C));
                        break;
                    case"unaccepted":
                        t.onUnaccepted && t.onUnaccepted(A), t.ignoreUnaccepted || (f = new Error("Aborted because " + u + " is not accepted" + C));
                        break;
                    case"accepted":
                ...
                if (f) return {error: f};
                if (m) for (u in l[u] = g, o(h, A.outdatedModules), A.outdatedDependencies) r.o(A.outdatedDependencies, u) && (d[u] || (d[u] = []), o(d[u], A.outdatedDependencies[u]));
                v && (o(h, [A.moduleId]), l[u] = p)
            }
            a = void 0;
            for (var w, b = [], D = 0; D < h.length; D++) {
                var k = h[D], E = r.c[k];
                E && (E.hot._selfAccepted || E.hot._main) && l[k] !== p && !E.hot._selfInvalidated && b.push({
                    module: k,
            ...
            return {
                dispose: function () {
                    ...
                    for (var e, a = h.slice(); a.length > 0;) {
                        var n = a.pop(), s = r.c[n];
                        if (s) {
                            var o = {}, l = s.hot._disposeHandlers;
                    ...
                    for (var u in d) if (r.o(d, u) && (s = r.c[u])) for (w = d[u], D = 0; D < w.length; D++) e = w[D], (t = s.children.indexOf(e)) >= 0 && s.children.splice(t, 1)
                }, apply: function (e) {
                    for (var a in l) r.o(l, a) && (r.m[a] = l[a]);
                    for (var i = 0; i < n.length; i++) n[i](r);
                    for (var c in d) if (r.o(d, c)) {
                        var s = r.c[c];
                        if (s) {
                            w = d[c];
                            for (var o = [], p = [], u = [], A = 0; A < w.length; A++) {
                                var g = w[A], f = s.hot._acceptedDependencies[g], m = s.hot._acceptedErrorHandlers[g];
                                if (f) {
        ...
        self.webpackHotUpdatewebpack_demo = (e, i, c) => {
            ...
            p.push(d), e = {}, i = s, a = h.reduce((function (t, e) {
                return t[e] = !1, t
            }), {}), n = [], t.forEach((function (t) {
                r.o(c, t) && void 0 !== c[t] ? (l.push(o(t, u)), e[t] = !0) : e[t] = !1
            })), r.f && (r.f.jsonpHmr = function (t, a) {
